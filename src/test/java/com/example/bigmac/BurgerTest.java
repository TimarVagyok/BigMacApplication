...
//some more test will be added one these are aggreed
    ...
    void testGetPriceWithNoToppings() {
        Burger burger = new Burger("Basic Burger", "Beef",
                "Bun", false, false, false,
    ...
    void testGetPriceWithLettuceAndTomato() {
        Burger burger = new Burger("Burger with Lettuce and Tomato", "Beef", "Bun",
    ...
    void testGetPriceWithCheeseAndBacon() {
        Burger burger = new Burger("Cheeseburger with Bacon", "Beef",
                "Bun", true, false, false,
    ...
    void testGetPriceWithAllToppings() {
        Burger burger = new Burger("Burger with All Toppings", "Beef",
                "Bun", true, true, true, true,
                true, true, true, true);
    ...
    void testGetPriceWithDifferentTypesOfMeat() {
        Burger beefBurger = new Burger("Beef Burger", "Beef", "Bun",
                true, true, true, false, false,
                false, false, false);
        assertEquals(5, beefBurger.getPrice());

        Burger chickenBurger = new Burger("Chicken Burger", "Chicken", "Bun",
                true, false, false, true, false,
                false, false, false);
        assertEquals(5.3, chickenBurger.getPrice());

        Burger veggieBurger = new Burger("Veggie Burger", "Veggie",
                "Bun", true, true, false, false,
